...
class GraphBinaryReader(object):
    def __init__(self, deserializer_map=None):
        ...
        # Internal int-keyed dispatch tables built from the public enum-keyed
        # map. The hot data_type-is-None path reads a raw type byte and can look
        ...
        # lookup. Rebuilt after any update to self.deserializers.
