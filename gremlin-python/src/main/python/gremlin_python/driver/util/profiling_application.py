...
class ProfilingApplication:
    ...
    def __init__(self, execution_name, url, pool_size, max_workers,
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Profiling application for gremlin-python driver")
    ...
    parser.add_argument("--script", default="g.inject(1)", help="Script to execute")
        ...
        if args.test_type == "throughput":
            ...
            for ix in range(args.warmups):
                ...
                app = ProfilingApplication(
                    ...
                    args.max_workers, 1000, executor, args.script,
            ...
            if args.exercise or meets_rps_expectation:
                ...
                for ix in range(args.executions):
                    ...
                    app = ProfilingApplication(
                        ...
                        args.max_workers, args.requests, executor, args.script,
                        args.too_slow_threshold, args.exercise,
                        args.suppress_stack_traces)
